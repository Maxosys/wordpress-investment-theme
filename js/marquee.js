...
$(document).ready(function() {
  ...
  $("#owl-example").owlCarousel({
      ...
      itemsMobile : [599,1],
      navigation : true,
      navigationText : ['<span class="fa-stack"><i class="fa fa-angle-left" aria-hidden="true"></i></span>','<span class="fa-stack"><i class="fa fa-angle-right" aria-hidden="true"></i></span>'],
  });
